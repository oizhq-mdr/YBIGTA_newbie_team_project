...
from review_analysis.preprocessing.ssg_processor import SsgProcessor
from review_analysis.preprocessing.homeplus_processor import HomeplusProcessor
from review_analysis.preprocessing.coupang_processor import CoupangProcessor
...
PREPROCESS_CLASSES: Dict[str, Type[BaseDataProcessor]] = {
    "reviews_ssg": SsgProcessor,
    "reviews_homeplus": HomeplusProcessor,
    "reviews_coupang": CoupangProcessor
...
# REVIEW_COLLECTIONS = glob.glob(os.path.join("../../database", "reviews_*.csv"))
# REVIEW_COLLECTIONS = glob.glob(os.path.join("database", "reviews_*.csv"))
print("REVIEW_COLLECTIONS", len(REVIEW_COLLECTIONS))
